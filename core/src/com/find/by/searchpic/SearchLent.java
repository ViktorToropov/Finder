...
public class SearchLent {
    ...
    public SearchLent(boolean[] stages,String searchPicImg) {
        ...
        texture = new Texture(Gdx.files.local("Data/imgChose/imL.jpg"));
    ...
    public void render(){
        ...
        spriteBatch.draw(texture, Gdx.graphics.getWidth()/2-razmer/2, Gdx.graphics.getHeight()-razmer*0.85f);
